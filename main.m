...
% partition data
X_train = X_all(1:5000, :);
y_train = y_all(1:5000, :);
X_cv = X_all(5001:6000, :);
y_cv = y_all(5001:6000, :);
X_test = X_all(6001:7000, :);
y_test = y_all(6001:7000, :);
...
figure(1); plot(1:max_hidden_layers, layer_train_cost, 1:max_hidden_layers, layer_cv_cost);
...
figure(2); plot(lambda_vec, lambda_train_cost, lambda_vec, lambda_cv_cost);
